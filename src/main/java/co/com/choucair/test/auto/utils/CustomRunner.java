...
public class CustomRunner extends Runner {
    ...
    static final Logger logger = LoggerFactory.getLogger(CustomRunner.class.getName());
    private Class<CucumberWithSerenity> classValue;
    private CucumberWithSerenity cucumberWithSerenity;

    public CustomRunner(Class<CucumberWithSerenity> classValue) throws InitializationError {
